...
<body class="flex items-center justify-center min-h-screen bg-blue-900">
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-center text-orange-500 flex items-center justify-center space-x-2">
            <img class="w-12" src="<?= base_url('assets/fotobin/logo.png'); ?>">    
            <span> Binco Ran Nusantara</span>
        </h2>
        <form action="<?= base_url('auth/login'); ?>" method="POST">
            <div>
                <label for="username" class="block text-sm font-medium text-gray-700">Username</label>
                <input type="text" id="username" name="username" required class="w-full p-2 mt-1 border rounded-md focus:ring-orange-500 focus:border-orange-500">
            </div>
            <div>
