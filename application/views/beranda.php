...
<section class="pt-0 position-relative overflow-hidden h-700px h-sm-600px h-lg-700px rounded-top-4 mx-2 mx-md-4">
    ...
    <div class="slideshow-wrapper">
        <?php foreach ($caraousel as $index => $c): ?>
            <div class="slide-image <?= $index === 0 ? 'active' : '' ?>" style="background-image: url('assets/upload/caraousel/<?= $c['foto'] ?>');">
                ...
                <!-- Slide Main Content -->
                <div class="container slide-content text-white">
                    <div class="row py-0 py-md-5 align-items-center text-center text-sm-start">
                        <div class="col-sm-10 col-lg-8 col-xl-6 my-5 mt-md-0">
                            <div class=" p-4 rounded">
                                <h1 class="text-white display-5"><?= htmlspecialchars($c['judul']) ?></h1>
                                <p class="text-white"><?= nl2br(htmlspecialchars($c['deskripsi'])) ?></p>
                                <a href="about.html" class="btn btn-primary mt-3">Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-xxl-6 position-relative">
                        ...
                        <!-- Title -->
                        <h2 class="h1">
                            <span class="position-relative z-index-9"><?= $about->title ?></span>
                            <span class="position-relative z-index-1">
                                ...
                                <span
                                    ...
                                    <svg class="fill-primary" width="180" height="86" viewBox="0 0 303 86">
                                        <path
                        ...
                        <p class="mt-4 mb-0"><?= $about->description ?></p>

                        <!-- List -->
                        <ul class="list-group list-group-borderless mt-4">
                            <?php foreach ($features as $feature) : ?>

                            <li class="list-group-item h6 d-flex fw-normal mb-0">
                        ...
                        <div class="d-sm-flex align-items-center mt-4">
                            <!-- Button -->
                            <a href="" class="btn btn-lg btn-dark me-2 mb-4 mb-sm-0">Read more</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="bg-danger bg-opacity-10 p-4 p-xl-5 text-center rounded-3 mb-4">
                                    <span class="h2 text-danger mb-2">100%</span>
                                    <h6 class="mb-0">Siap Kerja</h6>
                                </div>

                                <!-- Box item 2 -->
                                <div class="bg-light p-4 p-xl-5 text-center rounded-3">
                                    <span class="h2 text-primary mb-2">3</span>
                            ...
                            <div class="col-md-8 position-relative mt-5 mt-md-0">
                                ...
                                <!-- Image -->
                                <img src="<?= base_url('assets/upload/about/' . $about->image_main) ?>" class="rounded-3" alt="">
                                <!-- Image -->
                                <div
                                    class="col-10 position-absolute top-100 start-0 translate-middle mt-n6 ms-n3 d-none d-md-block">
                                    <img src="<?= base_url('assets/upload/about/' . $about->image_secondary) ?>" class="rounded-3" alt="">
                                </div>
                            </div>
...
About END -->
        ...
        <style>
            ...
            .arrow-connector {
                width: 40px;
                height: 40px;
                background: url('https://cdn-icons-png.flaticon.com/512/545/545682.png') no-repeat center;
        ...
        <section class="pt-0 pt-md-5 process-section">
            <div class="container">
                <!-- <div class="text-center" data-aos="fade-up">
                <h2 class="process-title">Siap wujudkan impianmu ke Jepang?</h2>
                </div>   -->
                <div class="row mb-3 mb-sm-4">
                    <div class="col-12 mx-auto text-center">
                        <h2 class="fs-1 fw-bold" data-aos="fade-up">
                            <span class="position-relative z-index-9">Alur Keberangkatan</span>
                            <span class="position-relative z-index-1"> ke Jepang
                                <!-- SVG START -->
                                <span
                                    class="position-absolute top-50 start-50 translate-middle z-index-n1 d-none d-sm-block">
                ...
                <div class="process-flow mt-5">
                    <!-- STEP 01 -->
                    <div class="process-step" data-aos="fade-up" data-aos-delay="100">
                        <div class="number">01</div>
                        <h5>Registrasi</h5>
                        <p>Calon peserta magang masuk ke sekolah bahasa Jepang (offline/online) di wilayah lokal.</p>
                    </div>

                    <div class="arrow-connector d-none d-md-block"></div>

                    <!-- STEP 02 -->
                    <div class="process-step" data-aos="fade-up" data-aos-delay="200">
                        <div class="number">02</div>
                        <h5>Lowongan Masuk</h5>
                        <p>Lowongan pekerjaan dikirim dari perusahaan ke sekolah Jepang mitra untuk rekrutmen.</p>
                    </div>
                    ...
                    <div class="process-step" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <h5>Seleksi Awal</h5>
                        <p>Seleksi tahap 1 dilakukan untuk menentukan kandidat wawancara.</p>
                    </div>
                    ...
                    <div class="process-step" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h5>Wawancara</h5>
                        <p>Wawancara bersama perusahaan dan lembaga pengawas. Biasanya kandidat sudah belajar bahasa
                            Jepang.</p>
                    </div>
                    ...
                    <div class="process-step" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <h5>Belajar Lanjutan</h5>
                        <p>Kandidat yang lolos wawancara belajar ±4 bulan di sekolah kami sebagai persiapan
                            keberangkatan.</p>
                    </div>
                    ...
                    <div class="process-step" data-aos="fade-up" data-aos-delay="600">
                        ...
                        <h5>Keberangkatan</h5>
                        <p>Pengurusan VISA dan prosedur selesai, peserta resmi berangkat ke Jepang.</p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="bg-light p-4 p-sm-5 rounded-3 position-relative overflow-hidden">
                            ...
                            <figure class="position-absolute top-0 start-0 d-none d-lg-block ms-n7">
                                <svg width="294.5px" height="261.6px" viewBox="0 0 294.5 261.6"
                                    style="enable-background:new 0 0 294.5 261.6;">
                                    <path class="fill-primary opacity-5"
                            ...
                            <figure class="position-absolute top-0 end-0 mt-5 me-n5 d-none d-sm-block">
                                <svg width="285px" height="272px">
                                    <path class="fill-info opacity-4"
                            ...
                            <div class="col-11 mx-auto position-relative">
                                <div class="row align-items-center">
                                    <!-- Title -->
                                    <div class="col-lg-8">
                                        <h3>Siap wujudkan impianmu ke Jepang?</h3>
                                        <p class="mb-3 mb-lg-0">Yuk, ngobrol langsung dengan tim kami dan cari tahu
                                            program terbaik yang cocok buat kamu.</p>
                                    </div>
                                    <!-- Button -->
                                    <div class="col-lg-4 text-lg-end">
                                        <a href="contact-us.html" target="_blank" class="btn btn-blue mb-0">Hubungi
                                            Kami</a>
                                    </div>
                                </div>
                            </div>
...
Action box END-->
        <!-- =======================
Video divider START -->
        <section class=" pt-0 pt-md-6 position-relative">
            <!-- SVG decoration -->
            ...
            <div class="container position-relative">
                <div class="row justify-content-between align-items-center my-5">
                    ...
                    <div class="col-lg-5 position-relative">
                        ...
                        <!-- Title -->
                        <h2 class="h1">Yuk intip serunya belajar & persiapan magang ke Jepang!</h2>
                    </div>

                    <div class="col-lg-7 position-relative mt-4 mt-lg-0">
                        <!-- TikTok Creator Embed -->
                        <div class="border border-5 border-white rounded-2 overflow-hidden">
                            <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@lpkmpk_koken"
                                data-unique-id="lpkmpk_koken" data-embed-from="embed_page" data-embed-type="creator"
                                style="max-width:100%; min-width:288px; height:100%; margin:0 auto;">
                                <section>
                                    <a target="_blank"
                                        href="https://www.tiktok.com/@lpkmpk_koken?refer=creator_embed">@lpkmpk_koken</a>
                                </section>
                            </blockquote>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <p class="mb-0">Cerita nyata dari mereka yang sudah meraih impiannya bersama MPK-KOKEN</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="tiny-slider arrow-round arrow-creative arrow-dark arrow-hover">
                <div class="tiny-slider-inner" data-autoplay="true" data-edge="5" data-arrow="true"
                    data-dots="false" data-items="3" data-items-xl="3" data-items-md="2" data-items-xs="1">

                    <?php foreach ($testimoni as $t): ?>
                    <div>
                        <div class="testimonial-card p-4 rounded-4 border text-center">
                            <h6 class="mb-2"><?= htmlspecialchars($t['nama']) ?></h6>
...
Testimoni Peserta END -->
        ...
        <!-- =======================
Gallery START-->
<?php $img_base = base_url('assets/assets/img/'); ?><style>
	.masonry-grid {
		column-count: 3;
		column-gap: 1.5rem;
	}
	...
	<div class="container">
		...
		<div class="row g-4">
			<div class="masonry-grid">
				<?php foreach ($documentation as $i => $item): ?>
					<div class="masonry-item <?= $i >= 6 ? 'd-none extra-item' : '' ?>">
						<div class="card overflow-hidden position-relative">
							<div class="card-overlay-hover">
								<img src="<?= base_url('assets/upload/dokumentasi/' . $item['foto']) ?>" 
									class="rounded-3 w-100" 
									alt="gallery image"
									style="object-fit: cover; width: 100%; height: auto;">
							</div>
							<a class="card-element-hover position-absolute w-100 h-100" data-glightbox
								data-gallery="gallery" href="<?= base_url('assets/upload/dokumentasi/' . $item['foto']) ?>">
		...
		<div class="row mt-4">
			<div class="col text-center">
				<button id="showMoreBtn" class="btn btn-primary px-4">Show More</button>
			</div>
		</div>
	</div>
</section>

<!-- Script to handle Show More -->
<script>
	document.getElementById('showMoreBtn').addEventListener('click', function () {
		document.querySelectorAll('.extra-item').forEach(el => el.classList.remove('d-none'));
