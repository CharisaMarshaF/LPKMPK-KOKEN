...
<head>
    <meta charset="utf-8">
    <link href="<?= base_url('assets/fotobin/logo.png'); ?>" rel="shortcut icon">
    ...
    <div class="top-bar-boxed h-[70px] md:h-[65px] z-[51] border-b border-white/[0.08] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
        <div class="h-full flex items-center">
            ...
            <a href="<?= base_url('/'); ?>" class="logo -intro-x hidden md:flex xl:w-[180px] block">
                <img alt="Binco App Logo" class="logo__image w-6" src="<?= base_url('assets/fotobin/logo.png'); ?>">
        ...
        <div class="flex overflow-hidden">
            ...
            <?php $menu = $this->uri->segment(2);?>
                ...
                <ul>
                    <li>
                        <a href="<?= site_url('admin/home') ?>" class="side-menu <?php if($menu=='home'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="home"></i> </div>
                            <div class="side-menu__title"> Dashboard </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/konten') ?>" class="side-menu <?php if($menu=='konten'){ echo"side-menu--active"; } ?> ">
                            <div class="side-menu__icon"> <i data-lucide="command"></i> </div>
                            <div class="side-menu__title"> Daftar Produk </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/caraousel') ?>" class="side-menu <?php if($menu=='caraousel'){ echo"side-menu--active"; } ?> ">
                            <div class="side-menu__icon"> <i data-lucide="skip-back"></i> </div>
                            <div class="side-menu__title"> Caraousel</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/testimoni') ?>" class="side-menu <?php if($menu=='testimoni'){ echo"side-menu--active"; } ?> ">
                            <div class="side-menu__icon"> <i data-lucide="skip-back"></i> </div>
                            <div class="side-menu__title"> Testimoni</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/galeri') ?>" class="side-menu <?php if($menu=='galeri'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="skip-forward"></i> </div>
                            <div class="side-menu__title"> Galeri</div>
                        </a>
                    </li>
                     <li>
                        <a href="<?= site_url('admin/about') ?>" class="side-menu <?php if($menu=='about'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="skip-forward"></i> </div>
                            <div class="side-menu__title"> About</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/about_founder') ?>" class="side-menu <?php if($menu=='about_founder'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="skip-forward"></i> </div>
                            <div class="side-menu__title"> About Profile</div>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?= site_url('admin/user') ?>" class="side-menu <?php if($menu=='user'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="users"></i> </div>
                            <div class="side-menu__title"> User</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/konfigurasi') ?>" class="side-menu <?php if($menu=='konfigurasi'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="command"></i> </div>
                            <div class="side-menu__title"> Konfigurasi </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= site_url('admin/recentlgn') ?>" class="side-menu <?php if($menu=='recentlgn'){ echo"side-menu--active"; } ?>">
                            <div class="side-menu__icon"> <i data-lucide="book"></i> </div>
                            <div class="side-menu__title"> Reccent Login </div>
                        </a>
                    </li>
