...
<div class="text-left mt-8">
	<a href="javascript:;" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview"
 		class="btn btn-primary">Tambah Caraousel</a>
</div>
<!-- END: Modal Toggle -->
    ...
    <div class="p-5">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left border-b"><?= $cc['deskripsi']; ?></td>
				<td class="text-left border-b">
					<img src="../assets/upload/caraousel/<?= $cc['foto']; ?>" alt="Foto" width="100">
				</td>
            ...
            <form action="<?= base_url('admin/caraousel/simpan') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
					...
					<div class="col-span-12">
						...
						<textarea name="deskripsi" id="modal-form-keterangan" class="form-control" rows="4" required></textarea>
					</div>
                    <div class="col-span-12">
    ...
    $(".delete-btn").click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?= base_url('admin/caraousel/delete_data/') ?>" + foto;
            }
        });
