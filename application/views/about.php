			...
			<div class="col-10 text-center mx-auto position-relative">
				...
				<figure class="position-absolute top-100 start-100 translate-middle ms-5 d-none d-md-block">
					<svg  width="21.5px" height="21.5px" viewBox="0 0 21.5 21.5">
						<polygon class="fill-primary" points="21.5,14.3 14.4,9.9 18.9,2.8 14.3,0 9.9,7.1 2.8,2.6 0,7.2 7.1,11.6 2.6,18.7 7.2,21.5 11.6,14.4 18.7,18.9 "/>
					</svg>
				</figure>
				<!-- SVG decoration -->
				<figure class="position-absolute top-0 start-100 translate-middle">
					<svg width="27px" height="27px">
						<path class="fill-info" d="M13.122,5.946 L17.679,-0.001 L17.404,7.528 L24.661,5.946 L19.683,11.533 L26.244,15.056 L18.891,16.089 L21.686,23.068 L15.400,19.062 L13.122,26.232 L10.843,19.062 L4.557,23.068 L7.352,16.089 L-0.000,15.056 L6.561,11.533 L1.582,5.946 L8.839,7.528 L8.565,-0.001 L13.122,5.946 Z"/>
					</svg>
				</figure>

				<!-- Title -->
				<h1 class="position-relative fs-2">
				Tempat belajar, dan melangkah menuju impian bekerja di Jepang dengan semangat dan disiplin.
				</h1>
			</div>
			<!-- Title and SVG END -->
		</div>
    ...
    <div class="col-6 col-md-4">
        <div class="row g-4">
            ...
            <div class="col-10 col-lg-6">
                <img class="rounded-4" src="<?= $img_base ?>LPK-581.jpg" alt="">
            </div>
            <!-- Image -->
            <div class="col-12">
                <img class="rounded-4" src="<?= $img_base ?>LPK-198.jpg" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="col-6 col-md-4 position-relative">
        ...
        <figure class="position-absolute bottom-0 start-0 ms-n5">
            ...
            <svg width="129px" height="133px"> 
                <path class="fill-blue" d="M127.581,25.993 ... Z"/> 
            </svg>
        </figure>
        <!-- Image -->
        <img class="rounded-4" src="<?= $img_base ?>LPK-231.jpg" alt="">
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-md-12">
                <div class="bg-grad-blue rounded-4 p-5 text-start">
                    <span class="text-white">Tujuan kami:</span>
                    <h3 class="text-white">“新しい挑戦に心を開き、自分の未来を切り拓こう。”
                        <small class="d-block mt-2 text-white-50">
                            Buka diri pada tantangan baru, dan bentuk masa depanmu sendiri.
                        </small>
                    </h3>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-12 col-lg-6">
                <img class="rounded-4" src="<?= $img_base ?>LPK-292.jpg" alt="">
            </div>
        </div>
    </div>
</div>
...
<section class="pt-0 pt-md-5">
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8">
				<h2><?= $about_founder->title ?></h2>
				<p class="mb-0"><?= $about_founder->description ?></p>
			</div>
		</div>
		...
		<div class="row align-items-center">
			<div class="col-lg-5 position-relative">
				...
				<!-- Image -->
				<img src="<?= base_url('assets/upload/about/' . $about_founder->image) ?>" class="rounded" alt="">
			</div>

			<div class="col-lg-7 mt-4 mt-lg-0">
				<!-- Title -->
				<h4 class="mb-3"><?= $about_founder->subtitle ?></h4>

				<!-- Content -->
				<p><?= $about_founder->paragraph_1 ?></p>
				<p><?= $about_founder->paragraph_2 ?></p>

				<!-- Info -->
				<ul class="list-group list-group-borderless mt-4">
				<?php foreach ($features_founder as $ff): ?>

				<li class="list-group-item d-flex">
					<i class="bi bi-patch-check-fill text-success me-2"></i><?= $ff['text'] ?>
				</li>
				        <?php endforeach; ?>
