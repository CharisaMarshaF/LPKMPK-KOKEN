...
class Excel extends CI_Controller {
    ...
    public function excel($nik){
        ...
        foreach (range('S', 'Z') as $col) {
            $sheet->getColumnDimension($col)->setWidth(2.5);
        }
...
//baris 45
        ...
        $sheet->getStyle('L45:M45')->getFont()->setBold(true)->setSize(12);
        $sheet->getStyle('L45:M45')->applyFromArray($styleHeader);
        ...
        if (file_exists($fotoPath) && !empty($cv->foto)) {
            ...
            $drawing->setWidthAndHeight(145, 175); // Sesuaikan ukuran jika perlu
