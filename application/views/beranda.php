...
Testimoni Peserta END -->
        ...
        <!-- =======================
Gallery START-->
<?php $img_base = base_url('assets/assets/img/'); ?>
        ...
        <div class="row mb-3 mb-sm-4">
            <div class="col-12 mx-auto text-center">
                <h2 class="fs-1 fw-bold">
                    <span class="position-relative z-index-9">Momen</span>
                    <span class="position-relative z-index-1">Terbaik Kami
                        <!-- SVG START -->
                        <span class="position-absolute top-50 start-50 translate-middle z-index-n1 d-none d-sm-block">
                            <!-- (SVG tidak diubah) -->
                            <svg class="fill-primary" width="250" height="86" viewBox="0 0 303 86"> ... </svg>
                        </span>
                        <!-- SVG END -->
                    </span>
                </h2>
